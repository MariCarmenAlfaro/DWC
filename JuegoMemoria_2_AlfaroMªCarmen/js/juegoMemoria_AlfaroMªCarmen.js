...
class JuegoMemoria extends Tablero {
    ...
    descubrirImagen(celda) {
        ...
        let carta1;
        let carta2;
        let carta3=document.getElementById(celda);
        ...
        if (carta1 == carta2) {
            this.sumaPuntos = this.sumaPuntos+10;
        }else if(carta1==carta3 ||  carta2== carta3){
            this.sumaPuntos = this.sumaPuntos+5;
        }
    ...
    funcionBorrar(){
        debugger
       let resultado=confirm("Estas seguro que desea abandonar la partida?");
     //  if(!resultado){ 
